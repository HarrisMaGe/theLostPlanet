...
bool BackGround_3::init()
{
	...
	auto pauseButton = MenuItemImage::create("UI/pause1.png", "UI/pause_pressed.png", CC_CALLBACK_1(BackGround_3::menuPauseCallBack, this));
	auto menu = Menu::create(pauseButton, NULL);
	menu->setPosition(Vec2(winSize.width - 37, 26));
	this->addChild(menu, 4);

	//第三关背景地面层
	Sprite* map1 = Sprite::create("/backGround/bg3.png");
	Sprite* map2 = Sprite::create("/backGround/bg3.png");
	//第一张设置在屏幕中间
	...
	this->addChild(map1, 0, Map_3_1);
	this->addChild(map2, 0, Map_3_2);
	//第三关背景上面一层
	Sprite* map3 = Sprite::create("/backGround/bg3(uplayer).png");
	Sprite* map4 = Sprite::create("/backGround/bg3(uplayer).png");
	...
	this->addChild(map3, 0, Map_3_3);
	this->addChild(map4, 0, Map_3_4);
	this->scheduleUpdate();
	return true;
}
void BackGround_3::update(float time)
{
	Size winSize = Director::getInstance()->getWinSize();
	Point origin = Director::getInstance()->getVisibleOrigin();

	Sprite*temMap1 = (Sprite*)this->getChildByTag(Map_3_1);
	Sprite*temMap2 = (Sprite*)this->getChildByTag(Map_3_2);
	//地面层切换速度
	...
	Sprite*temMap3 = (Sprite*)this->getChildByTag(Map_3_3);
	Sprite*temMap4 = (Sprite*)this->getChildByTag(Map_3_4);
	//调整上层速度
...
void BackGround_3::menuPauseCallBack(Ref * pSender)
{
