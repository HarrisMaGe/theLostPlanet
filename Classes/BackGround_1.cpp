...
bool BackGround_1::init() 
{
	...
	auto pauseButton = MenuItemImage::create("UI/pause1.png", "UI/pause_pressed.png", CC_CALLBACK_1(BackGround_1::menuPauseCallBack, this));
	auto menu = Menu::create(pauseButton, NULL);
	menu->setPosition(Vec2(winSize.width-37 , 26));
	this->addChild(menu, 4);

	//第一关背景地面层
	Sprite* map1 = Sprite::create("/backGround/bg1.png");
	Sprite* map2 = Sprite::create("/backGround/bg1.png");
	//第一张设置在屏幕中间
	...
	this->addChild(map1, 0, Map_1_1);
	this->addChild(map2, 0, Map_1_2);
	//第一关背景云层
	Sprite* map3 = Sprite::create("/backGround/bg1(uplayer).png");
	Sprite* map4 = Sprite::create("/backGround/bg1(uplayer).png");
	...
	this->addChild(map3, 0, Map_1_3);
	this->addChild(map4, 0, Map_1_4);
	this->scheduleUpdate();
	return true;
}


void BackGround_1::update(float time) 
{
	Size winSize = Director::getInstance()->getWinSize();
	Point origin = Director::getInstance()->getVisibleOrigin();


	Sprite*temMap1 = (Sprite*)this->getChildByTag(Map_1_1);
	Sprite*temMap2 = (Sprite*)this->getChildByTag(Map_1_2);
	//地面层切换速度
	...
	Sprite*temMap3 = (Sprite*)this->getChildByTag(Map_1_3);
	Sprite*temMap4 = (Sprite*)this->getChildByTag(Map_1_4);
	//调整上层速度
...
void BackGround_1::menuPauseCallBack(Ref * pSender) 
{
